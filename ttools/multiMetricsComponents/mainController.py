...
class MultiFontMetricsWindow(BaseWindowController):
    ...
    def updateUnicodeMinimum(self):
        ...
        allUnicodeData = {}
        for eachFont in self.fontsOrder:
            for eachKey, eachValue in list(eachFont.naked().unicodeData.items()):
